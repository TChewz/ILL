...
if (count(coppatrolarray) == 0) exitWith {hint "Contact a Developer"};

_newmarker = (floor(random(count coppatrolarray)));
_MarkerLocation = getMarkerPos (coppatrolarray select _newmarker);

if (markerType (coppatrolarray select _newmarker) == "") then {
	coppatrolarray = coppatrolarray - [_newmarker];
	while {markerType (coppatrolarray select _newmarker) == "" || count(coppatrolarray) != 0} do {
		_newmarker = (floor(random(count coppatrolarray)));
		_MarkerLocation = getMarkerPos (coppatrolarray select _newmarker);
		if (markerType (coppatrolarray select _newmarker) == "") then {
			coppatrolarray = coppatrolarray - [_newmarker];
...
if (markerType (coppatrolarray select _newmarker) == "" || count(coppatrolarray) == 0) exitWith {hint "Contact a Developer"};
...
if (count(coppatrolarray1) == 0) exitWith {hint "Contact a Developer"};

_newmarker1 = (floor(random(count coppatrolarray1)));
_MarkerLocation1 = getMarkerPos (coppatrolarray1 select _newmarker1);

if (markerType (coppatrolarray1 select _newmarker1) == "") then {
	coppatrolarray1 = coppatrolarray1 - [_newmarker1];
	while {markerType (coppatrolarray1 select _newmarker1) == "" || count(coppatrolarray1) != 0} do {
		_newmarker1 = (floor(random(count coppatrolarray1)));
		_MarkerLocation1 = getMarkerPos (coppatrolarray1 select _newmarker1);
		if (markerType (coppatrolarray1 select _newmarker1) == "") then {
			coppatrolarray1 = coppatrolarray1 - [_newmarker1];
...
if (markerType (coppatrolarray1 select _newmarker1) == "" || count(coppatrolarray1) == 0) exitWith {hint "Contact a Developer"};
