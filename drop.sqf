...
if ([_item, -(_amount)] call INV_AddInvItem) then 
	...
	_text = parseText format ["<t size='0.9'>Name: %1<br/>Item: %2<br/>Amount: %3",name player,_item call INV_getitemName,_amount];
	[format["%1 Drop",name player],_text] call addToLogs;
