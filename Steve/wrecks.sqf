...
while {true} do 
{
	_nearby = nearestObjects [(getMarkerPos _wreckSelection), ["Man"], 75];
	sleep 1;
...
Format['if (playerside == west) then {player sidechat "Multiple 911 calls have come in reporting a multiple car accident. Check your map for the location."};'] call broadcast;

_wreckLocation = ["wreckspawn1","wreckspawn2","wreckspawn3","wreckspawn4","wreckspawn5","wreckspawn6","wreckspawn7","wreckspawn8","wreckspawn9","wreckspawn10","wreckspawn11","wreckspawn12","wreckspawn13","wreckspawn14","wreckspawn15","wreckspawn16"];
...
"CarWreck2" setMarkerText "!!! ACCIDENT !!!";
