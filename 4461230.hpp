...
x = 0.35; y = 0.20;															   
 ...
 x = 0.40; y = 0.40;								
 w = 0.20; h = 0.04;																								
 text = "Toggle ILG Phone";																								
 action = "if (ILG_Phone_Action_Enable) then {ILG_Phone_Action_Enable=false;systemchat""ILG Phone Turned off."";}else{ILG_Phone_Action_Enable=true;systemchat""ILG Phone Turned on."";};closeDialog 0;";															
 };													
 ...
 w = 0.20; h = 0.04;																										
 text = "Hotkeys";																				
 action = "call Hotkey_DialogSetup;";														
 };		
 ...
 class FAQDialog{						idd = -1;												movingEnable = true;													controlsBackground[] = {DLG_BACK1, background};											objects[] = { };							controls[] = {InfoText, button_cancel, dummybutton};											class DLG_BACK1: Rscbackground															{																										x = 0.05; y = 0.05;								    w = 0.90; h = 0.90;												};													class background : RscBgRahmen										{																x = 0.05; y = 0.05;										    w = 0.90; h = 0.90;																		text = "FAQ";															};																			class InfoText : RscText		{																												idc = 1;												x = 0.08; y = 0.08;															    w = 0.84; h = 0.80;																								style = ST_MULTI;														lineSpacing = 1;								};										class button_cancel : RscButton		{										x = 0.40; y = 0.90;										w = 0.20; h = 0.04;								text = "Back";						action = "closedialog 0; [""Einstellungen""] execVM ""settings.sqf"";";													};																									class dummybutton : RscDummy {idc = 1036;};};class AboutDialog{						idd = -1;										movingEnable = true;									controlsBackground[] = {DLG_BACK1, background};								objects[] = { };											controls[] = {InfoText, button_cancel, dummybutton};																	class DLG_BACK1: Rscbackground				{				x = 0.05; y = 0.05;								    w = 0.90; h = 0.90;					};										class background : RscBgRahmen						{														x = 0.05; y = 0.05;													    w = 0.90; h = 0.90;																								text = "About";				};																								class InfoText : RscText										{																idc = 1;																		x = 0.08; y = 0.08;											    w = 0.84; h = 0.80;																		style = ST_MULTI;																						lineSpacing = 1;													};																																	class button_cancel : RscButton															{																		x = 0.40; y = 0.90;				w = 0.20; h = 0.04;						text = "Back";																						action = "closedialog 0; [""Einstellungen""] execVM ""settings.sqf"";";			};									class dummybutton : RscDummy {idc = 1037;};};