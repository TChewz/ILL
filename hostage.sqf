...
if((playersNumber WEST) < 4) exitWith {player groupChat "You can't do the hostage mission when there's less than 4 cops online!";};
...
Format ['[%1] call copNotify_Hostage;',player] call broadcast;

player groupchat "The police have been notified, get ready!";

_maskOn = player getVariable "FaceMaskOn";
...
while {true} do 
	...
	if (_minutecounter >= 1200 and alive player) exitWith
		...
		bnkgeld = bnkgeld + 150000;
		player groupchat "Well done, you kept the hostage for 20 minutes, $150,000 has been transfered to your account.";
		sleep 10;
