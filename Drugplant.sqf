...
if (_art == "Use") then 
{
	...
	if (IsCop) exitwith {};
	if ((player distance marea1 < 150) or (player distance marea2 < 150) or (player distance marea3 < 150) or (player distance marea4 < 150) or (player distance marea7 < 150)) then
	{
	...
	{
	player groupchat "You must be at least 100m away from the center of a gang area.";
	};
