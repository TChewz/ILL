...
//	_Transporter animate ["ramp_bottom", 1];
	...
	sleep 3;
		...
		if (_Transporter isKindOf "oltruc3") then {
			_Object attachTo [_Transporter,[0,-2,1]];
		};	
...
//		_Transporter animate ["ramp_bottom", 1];
		...
		//// Detach object
		sleep 3;
		_Object attachTo [_Transporter,[0,5,1]];
		sleep 2;
		deTach _Object;
		sleep 2;
		_Object setPos [(getPos _Transporter select 0)+5,(getPos _Transporter select 1),1];
...
//		_Transporter animate ["ramp_bottom", 1];
		...
		//// Detach object
		sleep 3;
		_Object attachTo [_Transporter,[0,-10,1]];
		sleep 2;
		deTach _Object;
		sleep 2;
		_Object setPos [(getPos _Transporter select 0)-10,(getPos _Transporter select 1),1];
