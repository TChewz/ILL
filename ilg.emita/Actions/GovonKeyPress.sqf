...
switch _key do
{
	...
	case 17: {
		...
		if(typeof _vcl == "Smallboat_1" or typeof _vcl == "Smallboat_2") then {
			...
			if(_spd <= 30 and _spd > 20) then {
				_vcl setVelocity [(_vel select 0) * 1.002, (_vel select 1) * 1.002, (_vel select 2) * 0.99];
			};
			if(_spd <= 40 and _spd > 30) then {
				_vcl setVelocity [(_vel select 0) * 1.003, (_vel select 1) * 1.003, (_vel select 2) * 0.99];
			};
		};
		...
		if(isEngineOn _vcl and !isnil "_lvl") then {
			...
			if(_lvl == 3) then {
				_vcl setVelocity [(_vel select 0) * 1.014, (_vel select 1) * 1.010, (_vel select 2) * 0.99];
			};
		};
	};
