...
ANIM_AllAnimationArray = [
	...
	["NavigationDriverReverse", "Guiding reverse", "anim", "Guiding reverse", 2, ""],
	["NavigationHeli", "Guide heli pilot", "anim", "Guide heli pilot", 2, ""],
	["AinvPknlMstpSnonWrflDr_medic0", "Test anim", "anim", "CPR", 2, ""],
