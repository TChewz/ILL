...
controlsBackground[] = {DLG_BACK1, background};				
objects[] = { };													
controls[] = {Key_Text,Key_List,INV_Text,INV_List,UseDrop_Text,UseDrop_List,Submit};										
class DLG_BACK1: Rscbackground					
{																		
x = 0.35; y = 0.20;															   
w = 0.44; h = 0.2;							
 ...
 x = 0.35; y = 0.20;								    
 w = 0.44; h = 0.2;																				
 text = "ILG Hotkey Setup";				
 };			
 
 class Key_Text : RscText
 {
 idc = -1;
...
class Submit : RscButton
{
		...
		x = 0.51; y = 0.35;												
		w = 0.12; h = 0.03;
		action = "[] call Hotkey_Configuration;";
};
};
...
class liste_1_button
{
 ...
 x = 0.05; y = 0.05;							   
 w = 0.90; h = 0.90;				
 text = "Island Life Liberation Player Checker";					
 };	/*																						
